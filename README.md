...
```
$ git clone git@github.com:mavericks-db/cr2-review-past-project.git
```
...
Feel free to check the [issues page](https://github.com/mavericks-db/cr2-review-past-project/issues).
